...
if(isset($_POST['submit']))
{
 ...
 $insert=mysql_query("insert into manager(name, email, password, number, gender, address,salary) values('$a','$b','$c','$d','$e','$f','$g')");
if(!$insert)
{echo "fail";}
...
<head>
    ...
    <style type="text/css">
        ...
        width: 720px;
            height: 400px;
            background-image: linear-gradient(135deg,gainsboro,white);
            margin-top: 100px;
        }
          table,
        td {
