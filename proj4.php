...
if(isset($_POST['submit']))
{
 ...
 $insert=mysql_query("insert into registration(name, email, password,number) values('$a','$b','$c','$d')");
if(!$insert)
{echo "fail";}
...
if(isset($login))
{
    ...
    {
        $sql=mysql_query("select * from registration where email='$email' and password='$password'");
...
?>
    ...
    <body>
        ...
        <div style="background-image: url(lo.jpeg);height: 600px">
            ...
            <h5 style="margin-bottom: 60px;margin-left:100px;padding-top: 200px"><b>LOGIN OR<a href="proj5.php" style="text-decoration:none ;color:brown"> REGISTER TO AN ACCOUNT</a></b></h5>
            <form method="post">
                ...
                <button type="submit" class="btn btn-md  btn-outline-dark" style="margin-left: 100px" name="login">Login</button>
            </form>
