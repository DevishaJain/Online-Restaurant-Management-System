...
if(isset($_POST['submit']))
{
 ...
 $insert=mysql_query("insert into admin(name, email, password, number, gender, address,salary) values('$a','$b','$c','$d','$e','$f','$g')");
if(!$insert)
{echo "fail";}
...
ACCOUNT SETTINGS
  ...
  <img class="card-img-top" src="admin.jpeg" alt="Card image cap">
  <div class="card-body">
    <h5 class="card-title">PROFILE</h5>
    <p class="card-text"></p>
  </div>
  <ul class="list-group list-group-flush">
    <li class="list-group-item"><b>NAME:</b> <?php echo $r['name']; ?>
    </li>
    <li class="list-group-item"><b>EMAIL:</b> <?php echo $r['email']; ?></li>
    <li class="list-group-item"><b>PASSWORD:</b> <?php echo $r['password']; ?></li>
    <li class="list-group-item"><b>NUMBER:</b> <?php echo $r['number']; ?></li>
  </ul>
   <?php
           }
            ?>
